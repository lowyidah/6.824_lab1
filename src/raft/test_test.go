...
// func TestBackupModified(t *testing.T) {
// 	servers := 5
// 	cfg := make_config(t, servers, false, false)
// 	defer cfg.cleanup()
...
// 	cfg.disconnect((leader1 + 3) % servers)
// 	cfg.disconnect((leader1 + 4) % servers)
// 	fmt.Print("Disconnected follower: ")
// 	fmt.Println((leader1 + 2) % servers)
// 	fmt.Print("Disconnected follower: ")
// 	fmt.Println((leader1 + 3) % servers)
// 	fmt.Print("Disconnected follower: ")
// 	fmt.Println((leader1 + 4) % servers)

// 	// submit lots of commands that won't commit
// 	for i := 0; i < 50; i++ {
// 		cfg.rafts[leader1].Start(i + 200)
// 	}
...
// 	cfg.disconnect((leader1 + 0) % servers)
// 	cfg.disconnect((leader1 + 1) % servers)
// 	fmt.Print("Disconnected leader: ")
// 	fmt.Println((leader1 + 0) % servers)
// 	fmt.Print("Disconnected follower: ")
// 	fmt.Println((leader1 + 1) % servers)

// 	// allow other partition to recover
// 	cfg.connect((leader1 + 2) % servers)
// 	cfg.connect((leader1 + 3) % servers)
// 	cfg.connect((leader1 + 4) % servers)
// 	fmt.Print("Reconnect follower: ")
// 	fmt.Println((leader1 + 2) % servers)
// 	fmt.Print("Reconnect follower: ")
// 	fmt.Println((leader1 + 3) % servers)
// 	fmt.Print("Reconnect follower: ")
...
// 	}
// 	cfg.disconnect(other)
// 	fmt.Print("Disconnected other follower: ")
// 	fmt.Println(other)

// 	// lots more commands that won't commit
// 	for i := 0; i < 50; i++ {
// 		cfg.rafts[leader2].Start(i + 400)
// 	}
...
// 	fmt.Print("Reconnect leader: ")
// 	fmt.Println((leader1 + 0) % servers)
// 	fmt.Print("Reconnect follower: ")
// 	fmt.Println((leader1 + 1) % servers)
// 	fmt.Print("Reconnect follower other: ")
// 	fmt.Println(other)

// 	// lots of successful commands to new group.
// 	for i := 0; i < 50; i++ {
// 		cfg.one(i+500, 3, true)
// 	}
...
// 		cfg.connect(i)
// 	}
// 	fmt.Println("Reconnected everyone")
// 	cfg.one(600, servers, true)
